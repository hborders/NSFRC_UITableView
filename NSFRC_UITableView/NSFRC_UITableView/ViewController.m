...
#define ADD_REMOVE_FETCHED_OBJECTS_WITH_UPDATES 1
#define USE_BATCH_FETCHED_RESULTS_CONTROLLER 1
...
#if USE_BATCH_FETCHED_RESULTS_CONTROLLER
...
- (void)controllerDidChangeContent:(NSFetchedResultsController *)controller {
    ...
    [managedObjectContext performBlockAndWait:^{
        ...
        NSArray *entities = [managedObjectContext executeFetchRequest:fetchRequest
                                                                error:NULL];
        if (entities) {
